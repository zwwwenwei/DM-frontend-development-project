...
import './NewJob.css'
import JobList from './FreelanceJobList'
import SearchJob from './FreelanceSearch'
import DeleteJob from './FreelanceDelete'
import { createFreelanceDocFromAuth } from '../utils/firebase'
...
function Freelance() {
    ...
    const { title_position, job_description, skills, project_length, min_payment, max_payment, working_houres, image } = contact
    console.log(contact);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            await createFreelanceDocFromAuth({ title_position, job_description, skills, project_length, min_payment, max_payment, working_houres, image });
